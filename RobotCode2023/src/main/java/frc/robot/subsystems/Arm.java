...
public class Arm extends SubsystemBase {
  ...
  public Arm() {
    ...
    shoulderPID = new ProfiledPIDController(1, 0, 0, new Constraints(2.5, 2.25));
    elbowPID = new ProfiledPIDController(0.4, 0, 0.03, new Constraints(2, 2.5));
    wristPID = new ProfiledPIDController(0.5, 0, 0, new Constraints(2, 2));
