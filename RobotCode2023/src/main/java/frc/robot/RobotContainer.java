...
<<<<<<< Updated upstream
    ...
    choose.addOption("Bottom One Cone Leave Balance ;)", m_Autos.bottomOneConeLeaveAutoCommand());
...
=======
    ...
    private void configureButtonBindings() {
        ...
        JoystickButtons.opY.whileTrue(// high
                new ArmPositions(new JointAngles(Math.toRadians(38), Math.toRadians(5.56), Math.toRadians(58.28)),
                        m_Arm));
        JoystickButtons.opX.whileTrue(// mid
                new ArmPositions(new JointAngles(Math.toRadians(-5.18), Math.toRadians(91.3), Math.toRadians(34)),
                        m_Arm));
        JoystickButtons.opDpadR.whileTrue(// cube
                new ArmPositions(new JointAngles(Math.toRadians(-42.7), Math.toRadians(-133.7), Math.toRadians(37.55)),
                        m_Arm));
        JoystickButtons.opDpadU.whileTrue(
                // coneupright
                new ArmPositions(
                        new JointAngles(Math.toRadians(-34.69), Math.toRadians(-139.75), Math.toRadians(37.55)),
                        m_Arm));
        JoystickButtons.opB.whileTrue(// feeder slope
                new ArmPositions(new JointAngles(Math.toRadians(-2), Math.toRadians(-162.5), Math.toRadians(115.2)),
                        m_Arm));
        JoystickButtons.opDpadD.whileTrue(// lyingcone
                new ArmPositions(
                        new JointAngles(Math.toRadians(-56.45), Math.toRadians(-139.75), Math.toRadians(95.84)),
                        m_Arm));
        JoystickButtons.opA.whileTrue(// default
                new ArmPositions(new JointAngles(Math.toRadians(-0.6), Math.toRadians(-162.5), Math.toRadians(137.6)),
                        m_Arm));
        JoystickButtons.opDpadL.whileTrue(// feeder slider
                new ArmPositions(new JointAngles(Math.toRadians(-21.68), Math.toRadians(-33.43), Math.toRadians(-88.5)),
                        m_Arm));
    }
    /**
     * 
