...
public final class Constants {
  ...
  public static final class ModuleConstants {
    ...
    public final static double FL_ENC_OFFSET = 151; // 183
    public final static double FR_ENC_OFFSET = 300; // 179
    public final static double BL_ENC_OFFSET = 145; // 221
    public final static double BR_ENC_OFFSET = 142; // 241
  }
  ...
  public static final class Electrical {
    ...
    public static final int FINGER = 17;
